...
if ( isset($_POST['btn_updateGeneralInfo']) ) {
  ...
  $loggedInUserInfo->last_name = $_POST['last_name'];
      ...
      <div class="col-md-8">
        ...
        <form action="" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="last_name" class="form-control" id="inputName" placeholder="Enter last name" value="<?php echo $loggedInUserInfo->last_name; ?>" />
          </div>
          <div class="form-group">
