...
// public function is object, $user is property
  ...
  public function emailIsValid() {
    ...
    // $user->id != self::loggedInUserId()   - nije moja email adresa
    if( $user && $user->id != self::loggedInUserId() ) {
